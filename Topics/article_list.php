                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <?php if (isset($_GET["p"])): ?>
                            <div>
                                ...
                                ?>
                                <div class="btn-group">
                                    <a class="btn btn-primary <?php if ($order == 1) echo "active" ?>" href="article_list.php?p=<?= $p ?>&order=1"><i class="fa-solid fa-arrow-down-1-9 fa-fw"></i></a>
                                    <a class="btn btn-primary <?php if ($order == 2) echo "active" ?>" href="article_list.php?p=<?= $p ?>&order=2"><i class="fa-solid fa-arrow-down-9-1 fa-fw"></i></a>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
